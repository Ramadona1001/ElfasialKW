                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="orignal_price" value="1" id="orignal_price" min="1" step="1" onkeypress='validate(event)' minlength="5" maxlength="6" class="form-control price" placeholder="@lang('tr.Price')" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="quantity" value="1" id="quantity" min="1" step="1" onkeypress='validate(event)' minlength="5" maxlength="6" class="form-control price" placeholder="@lang('tr.Quantity')" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="add_value" value="0" id="add_value" min="0" step="1" onkeypress='validate(event)' minlength="5" maxlength="6" class="form-control price" placeholder="@lang('tr.Added Value')" required>
                            </div>
                        </div>
