...
@php($style = 'style=font-size:25px;font-weight:bold;margin-top:15px;')
@endif
  ...
  <div class="container wide">
    ...
    <div class="col-lg-12 col-md-12">
      ...
      <div class="content-element">
            ...
            {{-- <a href="{{ route('frontend_buffet_services_choice',$category_id) }}" style="display:block;text-align:center;width:30%;margin-left:auto;margin-right:auto;" class="addToCart">@lang('tr.From Your Choice') - (@lang('tr.Buffets'))</a> --}}
            <!-- Info Boxes -->
            ...
            <div class="info-box-col">
                ...
                <div class="info-box-wrap info-box_2">
                  ...
                  <div class="info-box">
                    ...
                    <div class="box-img">
                      <a href="{{ route('frontend_buffet_services_details',$buffet->id) }}"><img src="{{ asset('buffets/'.$buffet->buffets_image) }}" class="img-thumbnail img-responsive services_item_img"></a>
                      <div class="" style="display: block;">
                      <a href="{{ route('frontend_buffet_services_details',$buffet->id) }}"><h2 style="font-family:Cairo;font-size:25px;font-weight:bold;margin-top:15px;text-align:center;">{{ $buffet->name }}</h2></a>
                      <h2 style="font-family:Cairo;font-size:16px;font-weight:bold;margin-top:5px;text-align: center;color: #f05f79;margin-bottom: 15px;">@lang('tr.Price'):  {{ $buffet->price }} {{ $system_currency }}</span>
