  ...
  <div class="container wide">
    ...
    <div class="col-lg-12 col-md-12">
      ...
      <div class="content-element">
        <div class="container">
         <h1 class="box-title col-12 text_alig" {{ $style }} >{{ $buffet->name }}</h1>
            <!-- Info Boxes -->
            ...
            <div class="info-boxes box_description ">    
              ...
              <div class="row">
                  ...
                  <div class="col-lg-3">
                      <img src="{{ asset('buffets/'.$img->image_path) }}" class="img-responsive img-thumbnail" alt="" srcset="">
                  </div>
                  @endforeach
              </div>
              <br>
              <p style="font-size:17px;">{{ $buffet->desc }}</p>
            </div>
            <h6> <strong>  @lang('tr.No Members'): {{ $buffet->no_members }} </strong> </h6>
            </div>
            ...
            <div class="col-lg-10" >
              <h3 class="box-title" {{ $style }} >@lang('tr.Price'): {{ $buffet->price }} {{ $system_currency }}</h3>
            </div>
