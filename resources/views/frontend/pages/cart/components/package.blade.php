@php($package = \App\Package::findOrfail($item->id))
    <div class="col-lg-2">
        <div class="product">
            <figure class="product-image">
              <a href="{{ route('frontend_services_packages_details',$package->id) }}"><img src="{{ asset('uploads/packages/'.$package->package_image) }}" style="width: 100%; height: 200px;" alt=""></a>
            </figure>
