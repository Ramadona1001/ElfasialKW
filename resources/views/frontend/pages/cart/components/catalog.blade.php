@php($catalog = \App\CatalogItem::findOrfail($item->id))
    <div class="col-lg-2">
        <div class="product">
            <figure class="product-image">
              <a href="{{ route('frontend_services_single_catalogs',$catalog->id) }}"><img src="{{ asset('uploads/itemsinventories/'.$catalog->iteminventory->inventory_image) }}" style="width: 100%; height: 200px;" alt=""></a>
            </figure>
