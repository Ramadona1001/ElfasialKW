...
@section('title',__('tr.From Your Choice'))
  ...
  <div class="container wide">
    ...
    <div class="col-lg-12 col-md-12">
      ...
      <div class="content-element">
            ...
            @foreach ($fromchoices as $fromchoice)
            ...
            <div class="info-box-col">
                ...
                <div class="info-box-wrap info-box_2">
                  ...
                  <div class="info-box">
                    ...
                    <div class="box-img">
                      <a href="{{ route('frontend_buffet_services_choice_details',$fromchoice->id) }}"><img src="{{ asset('/fromchoices/'.$fromchoice->fromchoice_image) }}" class="img-thumbnail img-responsive services_item_img" ></a>
                      <div class="" style="display: block;">
                      <a href="{{ route('frontend_buffet_services_choice_details',$fromchoice->id) }}"><h2 style="font-family:Cairo;font-size:25px;font-weight:bold;margin-top:15px;text-align:center;">{{ $fromchoice->name }}</h2></a>
                    </div>
                    <div>
                      <br>
                       <a href="{{ route('frontend_buffet_services_choice_details',$fromchoice->id) }}" class="addToCart btn btn-block col-12" >@lang('tr.Details')</a>
                 </div>
                    </div>
