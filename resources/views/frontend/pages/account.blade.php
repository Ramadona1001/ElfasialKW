...
@section('title',__('tr.My Account'))
    ...
    <div class="container wide">
      ...
      <div class="content-element8">
        ...
        <div class="align-center">
            <form action="{{ route('frontend_myaccount_post') }}" method="post">
                @csrf
            
            <div class="form-group row">
                <label class="col-xl-3 col-lg-3 col-form-label">@lang('tr.Name')</label>
                <div class="col-lg-9 col-xl-6">
                    <input class="form-control" type="text" value="{{ $customer->name }}" name="name" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9 col-xl-6">
                    <div class="input-group">
                        ...
                        <p type="text" style="width: 100%; color: #999; font-size: 1em; height: 42px; border-bottom: 1px solid #262626; background-color: transparent; text-align: left; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; -webkit-transition: box-shadow .35s ease, border-color .35s ease; transition: box-shadow .35s ease, border-color .35s ease;" class="form-control" aria-describedby="basic-addon1">{{ $customer->email }}</p>
                    </div>
                </div>
            </div>
