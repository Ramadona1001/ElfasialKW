                  ...
                  <main id="main" class="col-lg-12">
                    ...
                    <div class="products-holder item-col-2">
                      ...
                      <div class="product">
                        ...
                        <!-- - - - - - - - - - - - - - Product Image - - - - - - - - - - - - - - - - -->
                        <figure class="product-image">
                          <a href="{{ route('frontend_services_packages',$cat->id) }}"><img src="{{ asset('packages.jpg') }}" style="width: 100%; height: 100%;" alt=""></a>
                        </figure>
                        <!-- - - - - - - - - - - - - - End of Product Image - - - - - - - - - - - - - - - - -->
                        ...
                        <div class="product-description">
                          ...
                          <h5 class="product-name"><a href="{{ route('frontend_services_packages',$cat->id) }}">@lang('tr.Packages')</a></h5>
