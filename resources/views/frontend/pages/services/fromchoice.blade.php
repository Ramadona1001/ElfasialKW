                    ...
                    <div class="products-holder item-col-3">
                        ...
                        <div class="product">
                          ...
                          <figure class="product-image">
                            <a href="{{ route('frontend_buffet_services',$buffetCategory->categories_id) }}"><img src="{{ asset('buffet.jpg') }}" style="width: 420px; height: 330px;" alt=""></a>
                          </figure>
                        ...
                        <div class="product">
                          ...
                          <!-- - - - - - - - - - - - - - Product Image - - - - - - - - - - - - - - - - -->
                          <figure class="product-image">
                            <a href="{{ route('frontend_services_catalogs',$catalog->id) }}"><img src="{{ asset('uploads/catalogs/'.$catalog->catalog_img) }}" style="width: 420px; height: 330px;" alt=""></a>
                          </figure>
                          <!-- - - - - - - - - - - - - - End of Product Image - - - - - - - - - - - - - - - - -->
                          ...
                          <div class="product-description">
                            ...
                            <h5 class="product-name"><a href="{{ route('frontend_services_catalogs',$catalog->id) }}">{{ $catalog->name }}</a></h5>
